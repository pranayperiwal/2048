...
int main() {
  ...
  while (true) {
    ...
    //up move
      ...
      if(up(currentGameState, previousGameState, score, prevScore)){
        randomNum(1);
        printboard(true);
        numberOfMoves++;
      }
    ...
    //down move
      ...
      system("clear");
      cout<<flush;
      if(down(currentGameState, previousGameState, score, prevScore)){
        randomNum(1);
        printboard(true);
        numberOfMoves++;
      }
    ...
    //right move
      ...
      system("clear");
      cout<<flush;
      if(right(currentGameState, previousGameState, score, prevScore)){
        randomNum(1);
        printboard(true);
        numberOfMoves++;
      }
    ...
    //left move
      ...
      system("clear");
      cout<<flush;
      if(left(currentGameState, previousGameState, score, prevScore)){
        randomNum(1);
        printboard(true);
        numberOfMoves++;
      }
